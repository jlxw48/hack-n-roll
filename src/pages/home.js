...
export default function Home() {
    ...
    const description = "Having trouble figuring how to split costs with your friends?"
    return (
        <div>
            ...
            <div id='mainSignUpButtonContainer'>
                <Button variant='outlined' size='large' id='mainSignUpButton' endIcon={<DoubleArrowIcon />}>Try Now!</Button>
            </div>
        </div>
    )
}
